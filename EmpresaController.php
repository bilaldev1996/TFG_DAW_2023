...
class EmpresaController
{
    ...
    public function altaEmpresa()
    {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $this->view = 'registrarEmpresa';
            $cuerpo = ' <p>Una nueva empresa ha sido registrada en el sistema y requiere validación.</p>
            <p>A continuación se proporcionan los detalles de la empresa:</p>
            <ul>
            <li>Nombre de la empresa: ' . $nombre . '</li>
            <li>Email de contacto: ' . $email . '</li>
            <li>CIF: ' . $cif . '</li>
            </ul>
            <p>Por favor, ingresa a tu <a href="https://jobsnow.es/administrador/index.php?action=gestionarEmpresas">cuenta</a> de administrador y valida la empresa para que puedan acceder a su cuenta y utilizar nuestra plataforma.</p>';

            $asunto = 'Validar Empresa';

            $this->enviarCorreo($email, $cuerpo, $asunto);
            return 'registrado';
        }
    }
