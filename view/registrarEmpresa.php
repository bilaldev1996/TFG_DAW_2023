    ...
    <form class="w-full max-w-xxl" action="index.php?controller=EmpresaController&action=altaEmpresa" method="POST" enctype="multipart/form-data" id="formRegistroEmpresa">
        ...
        <div class="flex flex-wrap -mx-3 mb-2">
            ...
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                <label for="imagen" class="block text-gray-700 text-xs font-bold mb-2">LOGO EMPRESA</label>
        ...
        <div class="flex flex-wrap -mx-3 mb-2">
            ...
            <p class="w-full text-sm text-center text-gray-600 ml-">¿Ya tienes una cuenta? <a href="index.php?controller=EmpresaController&action=accesoEmpresa" class="text-secundario">Inicia Sesión</a></p>
        </div>
    </form>
