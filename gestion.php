...
class gestion
{
    ...
    public function verificarEmpresa()
    {
        ...
        $cuerpo = '<p>Estimado equipo de' . $nombre . '</p>
        <p>¡Nos complace informarles que su cuenta ha sido validada exitosamente!</p>
        <p>En nombre de nuestro equipo, queremos felicitarles por completar exitosamente el proceso de validación de su cuenta en nuestra plataforma. Esto significa que ahora tienen acceso completo a todas las funcionalidades y características de nuestra plataforma JobsNow.</p>
        <p>Para comenzar a utilizar su cuenta, por favor, haga clic en el siguiente enlace para iniciar sesión:</p>
        <p><a href="https://jobsnow.es/index.php?controller=EmpresaController&action=accesoEmpresa" class="text-blue-500">Iniciar Sesión</a></p>
        <p>Gracias por confiar en nosotros y por formar parte de nuestra comunidad. Estamos comprometidos en proporcionarles la mejor experiencia posible y en apoyarles en su búsqueda de talento o cualquier otro objetivo que tengan en mente.</p>
        <p>Si tienen alguna pregunta, inquietud o necesitan asistencia adicional, no duden en ponerse en contacto con nuestro equipo.</p>';
