                                ...
                                <tr>
                                    ...
                                    <td class="border px-4 py-2 flex gap-2">
                                        ...
                                        <?php if ($empresa->getVerificado() == 0) : ?>
                                            <a href="index.php?controller=gestion&action=verificarEmpresa&idEmpresa=<?= $empresa->getIdEmpresa() ?>&email=<?= $empresa->getEmail() ?>&nombre=<?= $empresa->getNombre() ?>" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Verificar</a>
                                        <?php endif ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
